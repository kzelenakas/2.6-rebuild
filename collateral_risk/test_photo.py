...
from collateral_risk import photo, engine
from collateral_risk.operators import photo_face_detected, photo_quality_flag
...
def test_photo_face_detected_operator_triggers_when_face_found(monkeypatch):
    ...
    import collateral_risk.photo as photo_module
